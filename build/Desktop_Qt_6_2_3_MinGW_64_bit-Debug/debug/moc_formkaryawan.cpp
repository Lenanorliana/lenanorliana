...
struct qt_meta_stringdata_FormKaryawan_t {
    const uint offsetsAndSize[6];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_FormKaryawan_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_FormKaryawan_t qt_meta_stringdata_FormKaryawan = {
    {
...
QT_MOC_LITERAL(35, 0) // ""
    ...
    "FormKaryawan\0on_pushButton_clicked\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_FormKaryawan[] = {
...
const QMetaObject FormKaryawan::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_FormKaryawan.offsetsAndSize,
    qt_meta_data_FormKaryawan,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_FormKaryawan_t
...
void *FormKaryawan::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FormKaryawan.stringdata0))
